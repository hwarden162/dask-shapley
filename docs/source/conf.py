...
from dask_shapley import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "dask-shapley"
...
html_title = f"dask-shapley v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/hwarden162/dask-shapley",
            "html": """
